hs.win.dev = {
	...
	constructor: function (thisPanel) {
	    ...
	    hs.win.dev.Create.superclass.constructor.call (this, config);
	},
    }),
    Read: Ext.extend (Ext.Window, {
	...
	constructor: function (tool, thisPanel, devPerm, toolPanel, config) {
	    ...
	    hs.win.dev.Read.superclass.constructor.call (this, config);
